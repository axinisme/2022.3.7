...
def creat_model():
    ...
    # stage1构建
    stage1_out = DownSampleLayerBlock(12)(inputs)
    stage1_out = FormerLayerBlock(64)(stage1_out)
    print("stage1_out:", stage1_out)
    # stage2构建
    stage2_out = DownSampleLayerBlock(64)(stage1_out)
    stage2_out = FormerLayerBlock(160)(stage2_out)
    print("stage2_out:", stage2_out)
    # stage3构建
    stage3_out = DownSampleLayerBlock(160)(stage2_out)
    stage3_out = FormerLayerBlock(160)(stage3_out)
    print("stage3_out:", stage3_out)
    # stage4构建
    stage4_out = DownSampleLayerBlock(160)(stage3_out)
    stage4_out = FormerLayerBlock(400)(stage4_out)
    stage4_out = FormerLayerBlock(400)(stage4_out)
    print("stage4_out:", stage4_out)
    # stage5构建
    stage5_out = DownSampleLayerBlock(400)(stage4_out)
    stage5_out = FormerLayerBlock(400)(stage5_out)
    stage5_out = FormerLayerBlock(400)(stage5_out)
    print("stage5_out:", stage5_out)
    # stage6构建
    stage6_out = DownSampleLayerBlock(400)(stage5_out)
    stage6_out = FormerLayerBlock(1024)(stage6_out)
    stage6_out = FormerLayerBlock(1024)(stage6_out)
    stage6_out = FormerLayerBlock(1024)(stage6_out)
    print("stage6_out:", stage6_out)
    # stage7构建
    stage7_out = DownSampleLayerBlock(1024)(stage6_out)
    stage7_out = FormerLayerBlock(1024)(stage7_out)
    stage7_out = FormerLayerBlock(1024)(stage7_out)
    stage7_out = FormerLayerBlock(1024)(stage7_out)
